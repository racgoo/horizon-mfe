...
> **⚠️ CSS टकराव हो सकता है।** चाइल्ड ऐप स्टाइल डॉक्युमेंट में इंजेक्ट होती हैं और होस्ट या दूसरी ऐप्स से टकरा सकती हैं। टकराव से बचने के लिए **जरूर** इनमें से एक इस्तेमाल करें: **(1) Shadow DOM** (`<horizon-app>`), **(2) सभी सेलेक्टर को** `[data-horizon-app="<name>"]` **से स्कोप करें**, या **(3) हैश/स्कोप्ड क्लास नाम** (जैसे CSS Modules)। सिर्फ ग्लोबल, अनस्कोप्ड स्टाइल पर निर्भर न रहें।
